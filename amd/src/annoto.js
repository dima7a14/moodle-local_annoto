    ...
    return {
        ...
        bootWidget: function() {
            ...
            if (window.Annoto) {
                ...
                if (this.params.playerType === 'videojs' && window.requirejs) {
                    window.require(['media_videojs/video-lazy'], (vjs) => {
        ...
        checkWidgetVisibility: function() {
            ...
            var reloadAnnoto = function(mutationList) {
                ...
                if (mutationList) {
                    mutationTarget = mutationList
                        .filter(m => !m.target.classList.contains('hide_section'))[0].target;
                }

                const player = self.findPlayer(mutationTarget);
                ...
                self.config.zIndex = playerNode.offsetParent === null ? 0 : initialZIndex;
